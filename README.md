...
(incluse dans le depot, push autorise via le secret scanning GitHub).
Elle donne un acces administrateur total au projet (Firestore, Auth,
configuration) et sert aux scripts de maintenance (nettoyage des comptes,
diagnostic serveur).
